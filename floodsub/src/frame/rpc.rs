...
use crate::frame::subopts::SubscriptionAction;
...
impl From<Frame> for RpcProto {
    /// Convert a [`Frame`] into a [`RpcProto`].
    fn from(frame: Frame) -> Self {
        Self {
            ...
            control: None, // Floodsub does not use control messages.
        }
    }
}
