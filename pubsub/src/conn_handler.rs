...
type Codec = ProstCodec<FrameProto>;
...
enum OutboundSubstreamState {
    ...
    PendingSend(Framed<Stream, Codec>, FrameProto),
...
pub struct Handler {
    ...
    send_queue: SmallVec<[FrameProto; 16]>,
