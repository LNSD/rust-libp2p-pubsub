...
use crate::rpc::{MessageProto, MessageRpc};
...
mod tests {
    ...
    use crate::signing::validator::verify_message_signature;
    ...
    mod libp2p_signer {
        use crate::signing::validator::{MessageValidator, StrictMessageValidator};
    ...
    mod author_only_signer {
        use crate::signing::validator::{MessageValidator, PermissiveMessageValidator};
